    ...
    internal static class HelperMethods
    {
        ...
        public static Bitmap GetScreenSnapshot(int x, int y, int width, int height)
        {
            ...
            try
            {
                ...
                Bitmap screenCopy = new Bitmap(rc.Width, rc.Height, PixelFormat.Format32bppArgb);
                ...
                using (Graphics gdest = Graphics.FromImage(screenCopy))
                {
                    ...
                    using (Graphics gsrc = Graphics.FromHwnd(IntPtr.Zero))
                    {
                        ...
                        int retval = BitBlt(hDC, 0, 0,
                            screenCopy.Width, screenCopy.Height, hSrcDC, x, y,
        ...
        public static BitmapSource ToBitmapSource(this Bitmap bmp)
        {
            ...
            {
                pImg = bmp.GetHbitmap();
                returnSource = Imaging.CreateBitmapSourceFromHBitmap(pImg, IntPtr.Zero, Int32Rect.Empty, BitmapSizeOptions.FromEmptyOptions());
            }
            catch
            {
                returnSource = null;
